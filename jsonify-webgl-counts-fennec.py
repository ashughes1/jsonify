...
def process_json(string):
    ...
    url = 'https://crash-stats.mozilla.com/api/SuperSearch/?app_notes=~WebGL&product=FennecAndroid&date=%3E%3D' + str(today) + '&_histogram.date=adapter_vendor_id&_histogram_interval.date=1d'
    data = get_json(url)
