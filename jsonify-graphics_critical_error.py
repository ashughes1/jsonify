...
def process_json(string):
    ...
    url = 'https://crash-stats.mozilla.com/api/SuperSearch/?product=Firefox&graphics_critical_error=!__null__&date=%3E%3D2015-08-03&_histogram.date=release_channel&_histogram_interval.date=1d'
    data = get_json(url)
